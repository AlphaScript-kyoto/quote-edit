# AI Context - Infinity Quote Batch App (ver.1.3.3)
...
**App version constant:** `quote_system.config.APP_VERSION` -> currently `"1.3.3"`  
...
| Ver | Notes |
|-----|-------|
| 1.3.3 | Initial-fee / support folders only when branching; Biz light -500; super/hyper path merge all sales (PDF under SB光 or IPS一括/ランニング表記); kishu no light; sales display 機種変更. |
